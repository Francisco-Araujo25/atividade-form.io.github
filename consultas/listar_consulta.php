...
<header class="page-header">
  <div class="container">
    ...
    <nav class="breadcrumb">
      <a href="/index.php">Início</a> / Consultas / Listar
    </nav>
  </div>
</header>
            ...
            <tbody>
              <?php while ($row = $resultado->fetch_assoc()): ?>
                ...
                <tr>
                  ...
                  <td>
                    <a href="editar_consulta.php?id=<?= (int)$row['id_consulta'] ?>" class="btn btn-secondary">
                      Editar
                    </a>
                  </td>
                  <td>
                    <a
                      href="excluir_consulta.php?id=<?= (int)$row['id_consulta'] ?>"
